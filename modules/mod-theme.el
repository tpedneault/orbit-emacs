...
(let* ((bg-main     "#1a1b26")
  ...
  (custom-theme-set-faces
   ...
   `(term-color-black               ((t (:background ,bg-dark :foreground ,bg-inactive))))
   ...
   `(term-color-bright-black        ((t (:background ,bg-dim :foreground ,fg-dim))))
   `(term-color-bright-red          ((t (:background ,red :foreground ,red :weight bold))))
   `(term-color-bright-green        ((t (:background ,green :foreground ,green :weight bold))))
   `(term-color-bright-yellow       ((t (:background ,amber :foreground ,amber :weight bold))))
   `(term-color-bright-blue         ((t (:background ,blue :foreground ,blue :weight bold))))
   `(term-color-bright-magenta      ((t (:background ,purple :foreground ,purple :weight bold))))
   `(term-color-bright-cyan         ((t (:background ,cyan :foreground ,cyan :weight bold))))
   `(term-color-bright-white        ((t (:background ,fg-main :foreground ,fg-main :weight bold))))
   ;; ── Font-lock ─────────────────────────────────────────────────────────────
   ...
   `(org-list-dt                    ((t (:foreground ,amber :weight bold))))
   ...
   `(org-table                      ((t (:inherit fixed-pitch :foreground ,fg-main))))
...
(let* ((bg-main     "#fdf6e3")
  ...
  (custom-theme-set-faces
   ...
   ;; ── Terminal / vterm ─────────────────────────────────────────────────────
   `(term                           ((t (:background ,bg-main :foreground ,fg-main))))
   `(term-color-black               ((t (:background ,bg-dark :foreground ,fg-main))))
   `(term-color-red                 ((t (:background ,red :foreground ,red))))
   `(term-color-green               ((t (:background ,green :foreground ,green))))
   `(term-color-yellow              ((t (:background ,amber :foreground ,amber))))
   `(term-color-blue                ((t (:background ,blue :foreground ,blue))))
   `(term-color-magenta             ((t (:background ,purple :foreground ,purple))))
   `(term-color-cyan                ((t (:background ,cyan :foreground ,cyan))))
   `(term-color-white               ((t (:background ,bg-main :foreground ,fg-main))))
   `(term-color-bright-black        ((t (:background ,bg-dim :foreground ,fg-dim))))
   `(term-color-bright-red          ((t (:background ,red :foreground ,red :weight bold))))
   `(term-color-bright-green        ((t (:background ,green :foreground ,green :weight bold))))
   `(term-color-bright-yellow       ((t (:background ,amber :foreground ,amber :weight bold))))
   ...
   `(term-color-bright-magenta      ((t (:background ,purple :foreground ,purple :weight bold))))
   `(term-color-bright-cyan         ((t (:background ,cyan :foreground ,cyan :weight bold))))
   `(term-color-bright-white        ((t (:background ,bg-main :foreground ,fg-main :weight bold))))
   ;; ── Font-lock ─────────────────────────────────────────────────────────────
   `(font-lock-comment-face         ((t (:foreground ,fg-dim :slant italic))))
   `(font-lock-comment-delimiter-face ((t (:foreground ,fg-dim))))
   `(font-lock-string-face          ((t (:foreground ,green))))
